      ...
      contract HomeworkGrading is AccessControl {
        ...
        constructor(address grader1,address grader2,address grade3,address grade4){
			...
			_setupRole(hWEvaluator_ROLE, grade3Address);

			grade4Address = grade4;
			_setupRole(hWEvaluator_ROLE, grade4Address);
		}
		...
		function GradeHW_Pending(address o1) public{
			require(o1 == grader2Address || hasRole(hWEvaluator_ROLE, o1));
